...
namespace Float.Core.Tests
{
    ...
    {
        const string ClientId = "a65231af-be50-4638-8bab-a5472869dbb2";
        const string ClientSecret = "ld9GzR*2I4BtZ!%eCnD!mxqPPLWIhdRX";
        const string Username = "developers+fcutu@gowithfloat.com";
        const string Password = "utucf";
        readonly Uri Url = new ("https://sparklearn-dev.gowithfloat.net");
